  ...
  entities: [
    {
      ...
      clues: [
        ...
        { key: "timezone", label: "Time zone", value: "UTC+01:00", difficulty: 3, spoilerLevel: "safe" },
        { key: "language", label: "Official language", value: "French", difficulty: 4, spoilerLevel: "safe" },
        { key: "capital", label: "Capital", value: "Paris", difficulty: 5, spoilerLevel: "late" },
      ],
      metadata: {
        clueCount: 5,
    ...
    },
    {
      ...
      clues: [
        ...
        { key: "timezone", label: "Time zone", value: "UTC+09:00", difficulty: 3, spoilerLevel: "safe" },
        { key: "language", label: "Official language", value: "Japanese", difficulty: 4, spoilerLevel: "safe" },
        { key: "capital", label: "Capital", value: "Tokyo", difficulty: 5, spoilerLevel: "late" },
      ],
      metadata: {
        clueCount: 5,
